...
class Notes:
    ...
    def input_data(user_subject_choice, unit, term, desc, x):
        try:
        ...
        # NOTES
            ...
            while True:
                ...
                while True:
                    ...
                    Notes.input_data(user_subject_choice=user_subject_choice, unit=user_inputUNIT, term=user_inputTERM, desc=user_inputDESC, x=x)
